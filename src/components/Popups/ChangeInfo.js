...
import style from "@/styles/components/change_info.module.css";
import Button from "@/components/Button";
import Input from "@/components/Input";

const ChangeInfo = ({visible, setVisible, loading, placeholder, onClick, value, setValue}) => {
