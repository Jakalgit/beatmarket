...
const Menu = ({menuLeft, setMenuLeft}) => {
    ...
    return (
        <motion.div className={style.menu_block} animate={{left: menuLeft}}>
            <Container>
                <Row>
            ...
            <div className={style.href_block}>
                <Link href={"/"} className={navbar_style.href + ' '+ style.href_margin}>Популярное</Link>
            </div>
            <div className={style.href_block}>
                <Link href={"/"} className={navbar_style.href + ' '+ style.href_margin}>Каталог</Link>
            </div>
            <div className={style.href_block}>
                <Link href={"/"} className={navbar_style.href + ' '+ style.href_margin}>Сообщения</Link>
            </div>
            <div className={style.href_block}>
                <Link href={"/"} className={navbar_style.href + ' '+ style.href_margin}>Поддержка</Link>
            </div>
            <div className={style.href_block}>
                <Link href={"/"} className={navbar_style.href + ' '+ style.href_margin}>Стать создателем</Link>
            </div>
        </motion.div>
    );
};
